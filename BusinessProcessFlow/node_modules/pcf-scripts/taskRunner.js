...
class TaskRunner {
    ...
    run(taskGroup) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.logMessage(`${locale_generated_2.translate(diagnosticMessages_generated_1.strings.initializing.key)}...`);
            ...
            for (let i = 0; i < Object.keys(tsg).length; i++) {
                ...
                try {
                    ...
                    this.logError(`${locale_generated_2.translate(diagnosticMessages_generated_1.strings.failed.key)}:`);
                    this._diagnostics.flush(this._colorize);
                    return;
                }
            }
            this.logMessage(`${locale_generated_2.translate(diagnosticMessages_generated_1.strings.succeeded.key)}`);
            this._diagnostics.flush(this._colorize);
        });
    }
    setCommandNames() {
